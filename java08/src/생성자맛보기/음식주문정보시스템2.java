...
public class 음식주문정보시스템2 {
	...
	final static int PRICE = 5000; // 안바꿀거면 final: 변경불가, 상수
	final static int PRICE1 = 3500; // 안바꿀거면 final: 변경불가, 상수
	final static int PRICE2 = 3000; // 안바꿀거면 final: 변경불가, 상수
	final static int PRICE3 = 4000; // 안바꿀거면 final: 변경불가, 상수
